...
import employment from '../../assets/detailpage/productmanager/Employment.png'
      ...
      const text = (
        <p style={{ paddingLeft: 24 }}>
          <Row>
            ...
            <Col span={12}>
              <span>PM定义，产品思维</span><br/>
              <span>互联网团队，PM工作职责</span><br/>
              <span>PM职业发展</span><br/>
              <span>产品-从想法到落地全链路管理</span><br/>
            </Col>
          </Row>
          <Row>
            <Col span={5}>
            ...
            <Col span={12}>
              <span>流程设计-VISIO，墨刀</span><br/>
              <span>信息架构-Xmind</span><br/>
              <span>原型设计-Axure</span><br/>
            </Col>
          </Row>
        </p>
      )
    return (
        ...
        <Row type='flex' justify='center' style={{marginBottom:30}}>
            ...
            <Row gutter={8} type='flex' justify='center'>
                <Col span={8}>
                <Card style={{textAlign:'center',height:274}}>
                    <h2>杨老师</h2>
                    <h4>5年产品经理</h4>
